...
<body>
  ...
  <!-- body -->
	<div class="container">
    	...
    	<hr class="mt-2 mb-3"/>
      <div class="container">
      	<img class="border border-secondary rounded" src="../assets/img/contact/bakery.jpg" alt="Bakery">
      </div>
      <hr class="mt-2 mb-3"/>
   </div>
    ...
    <div class="container">
      <form action="../functions/account.php" method="post">
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                <input name="fname" type="text" class="form-control mt-3 mb-3" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="First Name" required value="<?php if (isset($_SESSION['fname'])){echo $_SESSION['fname'];}?>">
              </div>
              <div class="col-md-6">
                <input name ="lname" type="text" class="form-control mt-3 mb-3" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Last Name" required value="<?php if (isset($_SESSION['lname'])){echo $_SESSION['lname'];}?>">
              </div>
            </div>
          </div>
          <div class="form-group">
              <input name="mail" type="email" class="form-control mb-3" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="E-mail Address" required value="<?php if (isset($_SESSION['mail'])){echo $_SESSION['mail'];}?>">
          </div>
          <div class="form-group">
              <textarea name="msg" class="form-control mt-3 mb-4" id="exampleFormControlTextarea1" rows="3" required placeholder="Enter query"></textarea>
          </div>
          <?php
          if (isset($_SESSION['msg_contact'])) {?>
          <div class="alert alert-warning" role="alert">
            <?php 
            echo $_SESSION['msg_contact'];
