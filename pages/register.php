			...
			<div class="col-md-6">
				...
				<form action = "../functions/account.php" method="post">
  				<div class="form-group">
    				...
    				<input type="email" class="form-control mb-3" id="mail" name="mail" aria-describedby="emailHelp" placeholder="yourmail@example.com">
  				</div>
  				<div class="form-group">
    				<label for="exampleInputPassword1" class="mb-2">Password</label>
    				<input type="password" class="form-control mb-3" id="pass" name="pass" placeholder="Password">
  				</div>
  				<button type="submit" name="login" class="btn btn-warning mt-3 mb-4 fonter">Log In</button>
				</form>
			</div>
			<div class="col-md-6">
				...
				<div class="form-group">
            		<div class="row">
              			<div class="col-md-6">
                			...
                			<input name="fname" type="text" class="form-control mb-3" id="fname" name="fname" aria-describedby="emailHelp" placeholder="Juan">
              			</div>
              			<div class="col-md-6">
              				<label for="exampleInputEmail1" class="mb-2">Last Name</label>
                			<input name ="lname" type="text" class="form-control mb-3" id="lname" name="lname" aria-describedby="emailHelp" placeholder="de la Cruz">
              			</div>
            		</div>
  				</div>
  				<div class="form-group">
  				...
  				<div class="form-group">
    				...
    				<input type="text" class="form-control mb-3" id="mnum" name="mnum" minlength="11" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" aria-describedby="emailHelp" placeholder="09123456789">
  				</div>
  				<div class="form-group">
    				<label for="exampleInputPassword1" class="mb-2">Password</label>
    				<input type="password" class="form-control mb-3" id="pass" name="pass" placeholder="Password">
  				...
  				<div class="form-group">
    				<label for="exampleInputPassword1" class="mb-2">Repeat Password</label>
    				<input type="password" class="form-control mb-3" id="pass" name="pass" placeholder="Repeat Password">
  				</div>
