<?php
	...
	if (isset($_POST['register'])){
		...
		if($conn->connect_error){
			...
			if ($res->num_rows > 0) {
				$_SESSION['message'] = "That e-mail address is already in use, please enter a new one";
				header("Location: http://localhost:8080/tinapay/signup/signup.php");
			} else {
	...
	if (isset($_POST['login'])){
		...
		// login query
			...
			if ($res->num_rows > 0) {
				...
				$_SESSION['message'] = "Wrong e-mail address/password";
